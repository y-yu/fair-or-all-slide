...
\begin{frame}
  ...
  \simplecallout[%
    ...
    2人の意見が何も反映されないためプライバシーは完全\ce{:person_gesturing_ok:}
  }
  ...
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \simplecallout[%
        ...
        希望が場合によっては流出するのは\\
        ゲーム性とみなすことができそう！\ce{:thinking_face:}
      }
      ...
      \begin{column}{0.4\textwidth}
          \begin{table}[h]
            ...
            \begin{tabularx}{0.9\textwidth}{@{}| Y | Y | X @{}}
              \cline{1-2}
              アリス & ボブ & \\ \cline{1-2}
              割勘  & 割勘 & \multirow{2}{\hsize}{$\Bigg\}$\ce{:person_gesturing_ok:}}\\ \cline{1-2}
              奢り  & 奢り &  \\ \cline{1-2}
              割勘  & 奢り & \multirow{2}{\hsize}{$\Bigg\}$\ce{:person_gesturing_no:}} \\ \cline{1-2}
              奢り  & 割勘 &   \\ \cline{1-2}
            \end{tabularx}
          \end{table}
      \end{column}
